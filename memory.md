...
- **Kết quả**:
  ...
  - Tích hợp thêm cấu hình `VNCOPTIONS=-disableBasicAuth` vào biến môi trường để tắt hoàn toàn bước nhập mật khẩu trên TV, mang lại trải nghiệm tiện lợi (vào thẳng trình duyệt không cần dùng remote TV để gõ phím).
