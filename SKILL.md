...
> - Tệp `memory.md` là nhật ký bộ nhớ công việc, ghi nhận tiến độ chi tiết của AI Agent qua mỗi phiên làm việc.
...
- **Cập nhật Bộ nhớ công việc (Memory)**: Ghi nhận chi tiết tiến độ công việc, các thay đổi và hướng giải quyết vào tệp [memory.md](file:///d:/Tìm/TNCB/memory.md) để các AI Agent khác tham khảo trong các phiên tiếp theo.
